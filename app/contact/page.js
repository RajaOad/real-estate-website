          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-6 text-[32px] font-bold uppercase text-gray-500 dark:text-white sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-dark-6">
                Contact us today for any inquiries or assistance. Our dedicated team is here to help you with your queries. Reach out to us via email, phone, or visit our office. We look forward to hearing from you!
                </p>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2">
              <iframe
    title="Google Maps"
    width="100%"
    height="450"
