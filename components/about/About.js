...
const About = () => {
  ...
  useEffect(() => {
    // Reset the startCounting state to false when the component mounts
            ...
            >
              <div className='flex flex-wrap justify-between'>
                <div className="counter-wrap">
                  <div className="text">
                    <span className="d-block number gradient-text text-2xl md:text-4xl font-semibold">
                      <CountUp start={0} end={50} duration={2} startOnMount={startCounting} />
                    </span>
                ...
                <div className="counter-wrap">
                  <div className="text">
                    <span className="d-block number gradient-text text-2xl md:text-4xl font-semibold">
                      <CountUp start={0} end={210000} duration={2} startOnMount={startCounting} separator="," />
                    </span>
                ...
                <div className="counter-wrap">
                  <div className="text">
                    <span className="d-block number gradient-text text-2xl md:text-4xl font-semibold">
                      <CountUp start={0} end={450} duration={2} startOnMount={startCounting} />
                    </span>
                ...
                <div className="counter-wrap">
                  <div className="text">
                    <span className="d-block number gradient-text text-2xl md:text-4xl font-semibold">
                      <CountUp start={0} end={100} duration={2} startOnMount={startCounting} />
                    </span>
