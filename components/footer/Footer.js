...
const Footer = () => {
  return (
    <footer className="bg-footer text-white">
      <div className="container mx-auto px-8 md:px-20 py-16 md:pt-28 md:pb-20 flex md:flex-row flex-wrap justify-center">
        ...
        <div className="text-center text-xs md:text-sm md:w-full md:mt-5 bg-agents px-8 py-8 md:px-20 md:py-10" style={{ color: 'rgba(255, 255, 255, 0.5)' }}>
          <p className="md:mb-3">
