...
const Navbar = () => {
  return (
    ...
    <div className="flex items-center">
      {/* Logo */}
      <Link href="/">
      <img src="/images/logo.png" alt="Logo" className="h-12 md:h-24 mr-4" />
      </Link>
    ...
    <div className="flex items-center space-x-2 font-semibold">
      ...
      <Link href="/contact" className="text-white hover:text-gray-300 hover:bg-[#001F5B] px-4 py-3 transition duration-500">CONTACT US</Link>
    </div>
    </div>
    <SignInSignUpButtons />
    <SignoutButton />
