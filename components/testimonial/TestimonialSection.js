      ...
      <div className="container-xl mx-4 md:mx-20" ref={ref}>
        <div className="row justify-content-center pb-4">
          <div className="col-md-7 text-center heading-section">
            <span className="subheading uppercase text-xs md:text-sm font-semibold text-blue-500">Testimonial</span>
            <h2 className="mb-3 text-3xl md:text-5xl font-semibold text-blue-500 pt-4 pb-2">Clients We Help</h2>
          </div>
        </div>
        <div className="row">
                ...
                <SplideSlide key={index}>
                  <motion.div variants={variants} custom={index}>
                    <div className="flex justify-center my-12 relative">
                      <div className="testimony-wrap bg-gray-100 p-8 rounded-lg shadow-md">
                        <div className="p-4 bg-blue-500 absolute left-5 -top-5 rounded-full text-white"><FaQuoteLeft /></div>
                        <div className="text mt-4">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="pl-4">
                              ...
                              <p className="uppercase text-blue-500 text-xs mt-2">{testimonial.position}</p>
                            </div>
                          </div>
                        </div>
                      </div>
